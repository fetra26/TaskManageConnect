<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <p>
                {{ __('Lorsque l’authentification à deux facteurs est activée, vous serez invité à fournir un jeton aléatoire sécurisé pendant l’authentification. Vous pouvez récupérer ce jeton depuis l’application Google Authenticator de votre téléphone.') }}
            </p>
        </div>
            ...
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                    <p class="font-semibold">
                        @if ($showingConfirmation)
                            {{ __('Pour terminer l’activation de l’authentification à deux facteurs, scannez le code QR suivant en utilisant l’application d’authentification de votre téléphone ou entrez la clé de configuration et fournissez le code OTP généré.') }}
                        @else
                            {{ __('L’authentification à deux facteurs est maintenant activée. Scannez le code QR suivant en utilisant l’application d’authentification de votre téléphone ou entrez la clé de configuration.') }}
                        @endif
                    </p>
                </div>
